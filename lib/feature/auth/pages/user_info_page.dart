...
import 'package:whatapp_messenger/common/widgets/show_h_bar.dart';
import 'package:whatapp_messenger/feature/auth/controller/auth_controller.dart';
import 'package:whatapp_messenger/feature/auth/pages/image_picker_page.dart';
    ...
    return Column(
      children: [
        CustomIconButton(
          onTap: onTap,
          icon: icon,
          iconColor: CommonColors.greenDark,
          minWidth: 50,
          border: Border.all(
